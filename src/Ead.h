...
public:
	...
	*/
	inline
	void set(unsigned int attack_ms, unsigned int decay_ms, uint8_t dec_end=255)
	{
		setAttack(attack_ms);
		setDecay(decay_ms);
    Q8n24decay_end = ((Q8n24_FIX1-256) * dec_end) >> 8;
	}
	...
	*/
	...
	uint8_t next()
	{
      ...
      Q8n24 decay_remain = Q8n24state - Q8n24decay_end;
      decay_remain -= (decay_remain * Q8n8decay)>>8;
      //if (decay_remain)
      Q8n24state = Q8n24decay_end - decay_remain;
		}
